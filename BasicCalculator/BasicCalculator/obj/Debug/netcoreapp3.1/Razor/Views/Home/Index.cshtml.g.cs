#pragma checksum "D:\basic calculator\BasicCalculator\BasicCalculator\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "119bfc555c84486ca6a66cf9dedc0e633a2c7772"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"119bfc555c84486ca6a66cf9dedc0e633a2c7772", @"/Views/Home/Index.cshtml")]
    ...
    function equ() {
        ...
        xmlhttp.open(""GET"", ""https://localhost:44316/Home/Operate?rawResult=""+ txt);
            xmlhttp.onreadystatechange = function () {
                if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                    d");
            WriteLiteral("isplay.value = xmlhttp.responseText;\r\n                }\r\n            }\r\n        xmlhttp.send();\r\n    }\r\n</script>");
        }
